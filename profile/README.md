PoB Redux is a desktop app for planning Path of Exile 1 and 2 builds. It runs Path of Building Community's own
calculation code, so its numbers match Path of Building.
